...
?>
<div class="popup mfp-hide" id="action">
	<h3 class="popup_header popup_header_small">Записаться на </h3>
	...
	<?= Html::hiddenInput('FormAction[product_id]', '', ['class' => 'product_id']) ?>
	...
	<?= $form->field($model, 'text')->textarea(['placeholder' => 'Комментарий'])->label('Комментарий') ?>

	<div class="form-group group-submit">
		<button type="submit">Записаться <img src="/img/loader.gif" class="loading" style="display:none;"></button>
	</div>
