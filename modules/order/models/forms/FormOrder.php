...
class FormOrder extends Model
{
    ...
    {
        return [
            [['name', 'phone', 'email', 'shipping', 'payment'], 'required', 'message' => 'Надо бы заполнить это поле'],
    ...
    public function send($email, $product = null)
    {
		...
		{
			$html1 = '';
			$html2 = 'Здравствуйте '.$this->name.'! Вы заказали товар(ы) (р.) на сайте '.$this->sitename;
